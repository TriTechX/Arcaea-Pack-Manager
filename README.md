...
- Once done, repack the directory you were working on, and set the names of the .pack and .json files to match the name of the .pack file you extracted, in this example we extracted arc_1.pack, so we will set the pack name to arc_1.pack, and the json name to arc_1.json
- To create a mod, put these new, packed files (new arc_1.pack and arc_1.json) in a folder called 'romfs', and put that folder in another folder called the name of your mod
